...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_aib7wyi', 'template_2egs3gj', form.current, 'R4ucChtxHkXvykbPW')
      .then((result) => {
      ...
      <div className="container contact__container">
        <div className="contact__options">
          ...
          <article className="contact__option">
            ...
            <h4>Instagram</h4>
            <h5>Yaman_goel</h5>
            <a href="https://www.instagram.com/yaman_goel/" target='_blank'>Send a message</a>
          </article>
          <article className="contact__option">
